...
self.addEventListener("fetch", e => {
  ...
  const isShell = url.origin === location.origin && !url.pathname.includes("/music/") && !url.pathname.endsWith("lyrics.json") && !url.pathname.endsWith("chords.json");
